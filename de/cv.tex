\documentclass{wesa_cv}

\setname{Walid}{El Sayed Aly}
\setaddress{Montabaur/Deutschland}
\setmobile{+49 171 3340421}
\setmail{w@wesa.dev}
\setposition{Freiberuflicher Software-Architekt | DevOps- \& Cloud-Consultant | Experte für On-Premises \& maßgeschneiderte Lösungen} %ignored for now
\setlinkedinaccount{https://www.linkedin.com/in/murat-can-El Sayed Aly-568a96b1/} %you can play with color of the template (red is also nice..)
\setgithubaccount{https://github.com/muratcanEl Sayed Aly}
\setmediumaccount{https://github.com/muratcanEl Sayed Aly}
\sethomeaccount{https://github.com/muratcanEl Sayed Aly}
...
%
% Summary
\addblocktext{Zusammenfassung}{
Erfahrener freiberuflicher Softwarearchitekt und DevOps \& Cloud Consultant mit Expertise in der Entwicklung skalierbarer Backend-Anwendungen und AWS-Cloud-Lösungen.
Leitung der Konzeption und des Designs anspruchsvoller IT-Systeme, z.B. im Bereich Vertragsmanagement.
Einsatz meines umfassenden Fachwissens, um maßgeschneiderte On-Premises- und Cloud-basierte Lösungen zu liefern.
}
